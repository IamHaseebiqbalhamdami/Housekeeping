...
import { Clock, Star, CheckCircle, Shield, Calendar, Phone, Mail, MapPin, Key } from "lucide-react"
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <Button className="w-full bg-[#012E71] hover:bg-blue-800 text-white">Book Service</Button>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Professional Airbnb cleaning services across Simcoe County for 26 years.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Airbnb Services</h3>
              <ul className="space-y-2 text-gray-300">
                <li>Turnover Cleaning</li>
                <li>Deep Clean Setup</li>
