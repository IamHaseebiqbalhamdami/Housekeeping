...
export default function UseCasesShowcase() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-gray-900 via-[#012E71] to-black text-white relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div ref={cardsRef} className="space-y-6">
              {useCases.map((useCase, index) => (
                <div
                  key={useCase.id}
                  className={`relative p-6 rounded-2xl border-2 transition-all duration-700 cursor-pointer hover:shadow-2xl ${
                    activeUseCase === index
                      ? 'border-white bg-gradient-to-r from-white/20 to-gray-200/20 scale-105 shadow-2xl'
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${activeUseCase === index ? 'from-white to-gray-300' : 'from-[#012E71] to-gray-700'} flex items-center justify-center transition-all duration-300`}>
                      {React.createElement(useCase.icon, { 
                        className: `w-6 h-6 ${activeUseCase === index ? 'text-[#012E71]' : 'text-white'}` 
                      })}
                    </div>
                    <div className="flex-1">
                      <h3 className="text-xl font-bold mb-2">{useCase.title}</h3>
                      <p className="text-gray-300 leading-relaxed mb-3">{useCase.description}</p>
                      ...
                      {activeUseCase === index && (
                        <div className="space-y-3 animate-in slide-in-from-top-2 duration-500">
                          ...
                          <Button className="bg-gradient-to-r from-[#012E71] to-blue-800 text-white hover:from-blue-800 hover:to-[#012E71] w-full transition-all duration-300 hover:scale-105">
            ...
            <div className="relative">
              <Card className="bg-gradient-to-br from-gray-800/50 to-black/50 backdrop-blur-lg border-gray-600 p-8 shadow-2xl">
                <div className="text-center space-y-6">
                  ...
                  <div className="relative w-full h-48 rounded-xl overflow-hidden mb-6">
                    ...
                    <div className="absolute top-4 left-4">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#012E71] to-blue-800 flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="text-3xl font-bold mb-4">{useCases[activeUseCase].title}</h3>
                    <p className="text-lg text-gray-300 leading-relaxed mb-6">
                      {useCases[activeUseCase].description}
                    </p>
                    
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center p-4 bg-gradient-to-br from-white/10 to-white/5 rounded-lg border border-white/10">
                        <div className="text-2xl font-bold text-white">{useCases[activeUseCase].stats.satisfaction}</div>
                        <div className="text-sm text-gray-300">Satisfaction</div>
                      </div>
                      <div className="text-center p-4 bg-gradient-to-br from-white/10 to-white/5 rounded-lg border border-white/10">
                        <div className="text-2xl font-bold text-white">{useCases[activeUseCase].stats.clients}</div>
                        <div className="text-sm text-gray-300">Happy Clients</div>
                      </div>
                      <div className="text-center p-4 bg-gradient-to-br from-white/10 to-white/5 rounded-lg border border-white/10">
                        <div className="text-2xl font-bold text-white">{useCases[activeUseCase].stats.rating}</div>
                    ...
                    <div className="flex space-x-3">
                      <Button className="flex-1 bg-gradient-to-r from-[#012E71] to-blue-800 text-white hover:from-blue-800 hover:to-[#012E71] transition-all duration-300 hover:scale-105">
